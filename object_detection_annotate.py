...
def post_process(input_stream, input_data, out_path, progress_data, scale_frame_rate, scale_resolution):
    ...
    if cap.isOpened():   
        ...
        vw = cv2.VideoWriter(out_path, cv2.VideoWriter_fourcc(*'vp80'), 50.0 / scale_frame_rate, (out_w, out_h), True)
...
def main():
    ...
    output_stream = f"{args.output_dir}{job_id}/output_{job_id}.webm"
